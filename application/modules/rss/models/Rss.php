...
class Rss extends Zend_Db_Table {
    ...
    /**
     *
     * @param type $channel_sys_name
     * @return type Zend_Db_Table 
     */
    public function getRssFeedByName($channel_sys_name){
    
        $select = $this->select()
                ->where('cannel_sys_name',$channel_sys_name);
     ...
     */
    public function addRss($row, $data)
    {
