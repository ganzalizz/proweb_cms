...
class Otzivy_Admin_OtzivyController extends MainAdminController {
    ...
    public function init() {
        ...
        $this->view->currentModul = SP.'otzivy'.SP.$lang.SP.$this->getRequest()->getControllerName();
    }
    ...
    public function indexAction() {
        ...
        $this->view->otzivy = Otzivy::getInstance()->fetchAll();
        $this->view->total = Otzivy::getInstance()->getCount("id_page='".$this->_id_page."'");
