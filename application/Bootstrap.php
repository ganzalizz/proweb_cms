...
{                      
    ...
    public function init() {
      ...
      // require_once(ROOT_DIR . 'application/library/Zend/Loader/Autoloader.php');
       ...
       require_once (APPLICATION_PATH.'/common/controllers/MainAdminController.php');
    ...
    public static function defineDirectoriesConstants() {
        ...
        define('DIR_APPLICATION', APPLICATION_PATH . DS);
        define('DIR_MODULES', APPLICATION_PATH . DS . 'modules' . DS);
        define('DIR_LIBRARY', ROOT_DIR . '/../library' . DS);
        define('DIR_COMMON', APPLICATION_PATH . DS. 'common' .  DS);
