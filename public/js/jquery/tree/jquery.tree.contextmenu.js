		...
		"contextmenu" : {
			...
			show : function(obj, t) {
				...
				for(var i in opts.items) {
					...
					if(opts.items[i].separator_before === true) str += "<li class='separator"+ (r == 0 ? ' disabled' : '') +"'><span>&nbsp;</span></li>";
					str += '<li class="'+ (r == 0 ? 'disabled' : '') +'" ><a href="#" rel="' + i + '" class="' + i + ' ' + (r == 0 ? 'disabled' : '') + '">';
					...
					if(opts.items[i].separator_after === true) str += "<li class='separator"+ (r == 0 ? ' disabled' : '') +"'><span>&nbsp;</span></li>";
				}
