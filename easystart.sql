...
--
-- Хост: localhost
-- Время создания: Ноя 30 2010 г., 16:33
...
CREATE TABLE IF NOT EXISTS `site_articles` (
  ...
  `type` varchar(50) NOT NULL DEFAULT 'articles',
...
INSERT INTO `site_articles` (`id`, `id_page`, `type`, `name`, `url`, `intro`, `content`, `pub`, `main`, `prizn`, `created_at`, `pub_date`, `number`, `seo_title`, `seo_keywords`, `seo_descriptions`, `small_img`, `big_img`) VALUES
(1, 1076, 'articles', 'Новая мега статья', NULL, '<p>Фуфелок фуфелок и фуфелок еще один</p>', '<p>Фуфелок фуфелок и фуфелок еще один</p>', 1, 0, NULL, '2010-11-10', '2010-11-10 16:38:41', 0, NULL, NULL, NULL, NULL, NULL),
(2, 1076, 'articles', 'Новая мега статья', NULL, '<p>Фуфелок фуфелок и фуфелок еще один</p>', '<p>Фуфелок фуфелок и фуфелок еще один</p>', 1, 0, NULL, '2010-11-10', '2010-11-10 16:40:45', 0, NULL, NULL, NULL, NULL, NULL),
(3, 1076, 'articles', '1232456879', NULL, '<p>&lt;option value=&quot;0&quot;&gt;&lt;/option&gt;&lt;option value=&quot;0&quot;&gt;&lt;/option&gt;&lt;option value=&quot;0&quot;&gt;&lt;/option&gt;</p>', '<p>&lt;option value=&quot;0&quot;&gt;&lt;/option&gt;&lt;option value=&quot;0&quot;&gt;&lt;/option&gt;&lt;option value=&quot;0&quot;&gt;&lt;/option&gt;&lt;option value=&quot;0&quot;&gt;&lt;/option&gt;</p>', 1, 0, 3, '2010-11-10', '2010-11-10 17:43:38', 0, '', '', '', NULL, NULL);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 PACK_KEYS=0 AUTO_INCREMENT=1083 ;
...
(426, 'newslist', 'Список новостей', 'news', 'news', 'index', 'admin_news', 'index', 0, 1, 1),
...
(10, 'news', '0.2', 'Новости', 'Используется для работы с новостями', '2010-11-30', NULL, 0, 1, 0),
...
INSERT INTO `site_news` (`id`, `name`, `link`, `teaser`, `content`, `date_news`, `author`, `created_at`, `is_active`, `is_main`, `is_hot`, `count_views`, `seo_title`, `seo_descriptions`, `seo_keywords`, `small_img`, `big_img`) VALUES
(1, 'У нас новое блюдо - 1!', NULL, '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука! В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '2010-03-31 15:17:42', 'Администратор', '2010-03-31', 1, 1, 0, 0, 'Блюдо 1', 'Блюдо 1', 'Блюдо 1', '1_small.jpg', '1_big.jpg'),
(2, 'У нас новое блюдо - 2!', NULL, '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука! В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '2010-03-31 15:17:42', 'Администратор', '2010-03-31', 1, 1, 0, 0, 'У нас новое блюдо - 2!', 'У нас новое блюдо - 2!', 'У нас новое блюдо - 2!', '2_small.jpg', NULL),
(3, 'У нас новое блюдо - 3!', NULL, '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука! В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '2010-03-31 15:17:42', 'Администратор', '2010-03-31', 1, 1, 0, 0, 'У нас новое блюдо - 3!', 'У нас новое блюдо - 3!', 'У нас новое блюдо - 3!', '', NULL),
(4, 'У нас новое блюдо - 4!', NULL, '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука! В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '2010-03-31 15:17:42', 'Администратор', '2010-03-31', 1, 0, 0, 0, 'У нас новое блюдо - 4!', 'У нас новое блюдо - 4!', 'У нас новое блюдо - 4!', '4_small.jpg', NULL),
(5, 'У нас новое блюдо - 5!', NULL, '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука! В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '2010-03-31 15:17:42', 'Администратор', '2010-03-31', 1, 0, 0, 0, 'У нас новое блюдо - 5!', 'У нас новое блюдо - 5!', 'У нас новое блюдо - 5!', '5_small.jpg', NULL),
(6, 'У нас новое блюдо - 7!', NULL, '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука! В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '2010-03-31 15:17:42', 'Администратор', '2010-03-31', 1, 0, 0, 0, 'У нас новое блюдо - 7!', 'У нас новое блюдо - 7!', 'У нас новое блюдо - 7!', '6_small.jpg', NULL),
(7, 'У нас новое блюдо - 8!', NULL, '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука! В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '2010-03-31 15:17:42', 'Администратор', '2010-03-31', 1, 0, 0, 0, 'У нас новое блюдо - 8!', 'У нас новое блюдо - 8!', 'У нас новое блюдо - 8!', '7_small.jpg', NULL),
(8, 'У нас новое блюдо - 9!', NULL, '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука! В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '2010-03-31 15:17:42', 'Администратор', '2010-03-31', 1, 0, 0, 0, 'У нас новое блюдо - 9!', 'У нас новое блюдо - 9!', 'У нас новое блюдо - 9!', '8_small.jpg', NULL),
(9, 'У нас новое блюдо - 10!', NULL, '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '<p>В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука! В меню добавлены ребрышки свиные и картофель по-деревенски. Безумно оболденная штука!</p>', '2010-03-31 15:17:42', 'Администратор', '2010-03-31', 1, 0, 0, 0, 'У нас новое блюдо - 10!', 'У нас новое блюдо - 10!', 'У нас новое блюдо - 10!', '9_small.jpg', NULL),
(13, 'Еда', '', '<p>\r\n	kjhkjlhhk</p>\r\n<div firebugversion="1.5.4" id="_firebugConsole" style="display: none;">\r\n	&nbsp;</div>', '<p>\r\n	jhg dfvdf еда аыва</p>\r\n<div firebugversion="1.5.4" id="_firebugConsole" style="display: none;">\r\n	&nbsp;</div>', '2010-04-09 12:12:08', 'Администратор', '2010-04-03', 1, 0, 0, 0, '', '', '', 'test.jpg', NULL),
(23, '123', NULL, '<p>авыавы</p>', '<p>выавыа</p>', '2010-04-09 13:38:46', 'Администратор', '2010-04-23', 1, 0, 0, 0, '', '', '', NULL, NULL),
(33, 'Очередное новое блюдо!', NULL, '<p>анонс анонс анонс анонс анонс анонс анонс анонс анонс анонс </p>', '<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>\r\n<p>тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело тело</p>', '2010-04-15 12:26:24', 'Администратор', '2010-04-14', 1, 1, 0, 0, '', '', '', '33_small.jpg', '33_big.jpg'),
(53, '', '', '', '', '0000-00-00 00:00:00', '', '0000-00-00', 0, 0, 0, 2, '', '', '', NULL, NULL),
(83, '5445', NULL, '', '', '2010-05-11 11:46:24', 'Администратор', '2010-05-07', 1, 1, 0, 6, '', '', '', NULL, NULL),
(84, 'FGkldjslfkjdsklf fdskjdfklsd fkjfkjsdlf', 'http://test.by', '<p>\r\n	fsfsklfjsdlkfjsd fsdkjfskjfsd dslkfjsdkjfksdf sdlfkjsdkljf</p>', '<p>\r\n	dskljfksldjfklsdjf sdkjfksdljf kdsjfklsdjf</p>', '2010-11-23 00:00:00', 'dfdsfd gfgdfg', '2010-11-23', 1, 0, 0, 0, 'cxvvzcx xcvzcxbcxz xczvcxz', 'xzvxvzxc vzxvxzv vzxvxzv', 'xcvzxv xczvxcvz cxvxzvxcv', NULL, NULL),
(85, 'fdsgsdgdsgdg gfsdgfsdgsgsfdgds', 'http://test.by', '<p>\r\n	gsfdgsdgfsdfgdsfgdf gdsfgdsgdsf gfdsgsdfgsdfgsd gsfdgdsfgsdgsd</p>', '<p>\r\n	dsgdgfsdgsdgdf gfsdgsdfgdsg gdsfsgdsgsd dfsgsdg</p>', '2010-11-23 00:00:00', 'fdsghfdsdfhdfshdfsdshds', '2010-11-09', 1, 0, 0, 0, 'sddfghdfshdfs fdhsdfhfdhds dshdf', 'sdhsdfh dsfhdfshdf dfs dfshsdhsdhd', 'hsdhsdfhsd sdhfddssd dfshsdhsdh', NULL, NULL),
(86, 'fdsgsdgdsgdg gfsdgfsdgsgsfdgds', 'http://test.by', '<p>\r\n	gsfdgsdgfsdfgdsfgdf gdsfgdsgdsf gfdsgsdfgsdfgsd gsfdgdsfgsdgsd</p>', '<p>\r\n	dsgdgfsdgsdgdf gfsdgsdfgdsg gdsfsgdsgsd dfsgsdg</p>', '2010-11-23 00:00:00', 'fdsghfdsdfhdfshdfsdshds', '2022-11-20', 1, 0, 0, 0, 'sddfghdfshdfs fdhsdfhfdhds dshdf', 'sdhsdfh dsfhdfshdf dfs dfshsdhsdhd', 'hsdhsdfhsd sdhfddssd dfshsdhsdh', 'test.jpg', NULL),
(87, 'FGkldjslfkjdsklf fdskjdfklsd fkjfkjsdlf', 'http://test.by', '<p>\r\n	ffffffffffffffffffffffff ffffffffffffffffffffffffffffffffffff ffffffffffffffffffffffffffffffff</p>', '<p>\r\n	ffffffffffffffffffffffffffffffffffffffffffffff fffffffffffffffffffffffffffffffffffffffffff fffffffffffffffffffffffffffff</p>', '2010-11-23 00:00:00', 'dddddddddddd', '2010-11-15', 1, 0, 1, 0, 'sddfghdfshdfs fdhsdfhfdhds dshdf', 'sdhsdfh dsfhdfshdf dfs dfshsdhsdhd', 'hsdhsdfhsd sdhfddssd dfshsdhsdh', NULL, NULL),
(88, 'FGkldjslfkjdsklf fdskjdfklsd fkjfkjsdlf', 'http://test.by', '<p>\r\n	sssssssssssssssssssssssssddddddddddddddvddddddddddddddddd dddddddddddddddddddddddddddd</p>', '<p>\r\n	dddddddddddddddddddddddddddddddddd ddddddddddddddddddddddddd ddddddddddddd</p>', '2010-11-23 00:00:00', 'fffffffffffffff ffffffffffffffffffff', '2010-11-23', 1, 0, 1, 0, 'fggggggggggggggggggg gggggggggggggggggggggg', 'ggggggggggggggggggg gggggggggggggggggggg', 'gggggggggggggggggggggg ggggggggggggggggggg', NULL, NULL),
(89, 'fdsgsdgdsgdg gfs5689', 'http://test.by', '<p>\r\n	sssssssssssssssssssssssssssssff&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ffffffffffffffffffffffffffffffff ffffffffffffffffffffffffffffffff</p>', '<p>\r\n	fffffffffffffffffffffffffffffffffffffffffffffffff</p>\r\n<p>\r\n	ffffffffffffffffffffffffffffffffffffffff</p>\r\n<p>\r\n	fffffffffffffffffffffffffff</p>', '2010-11-23 00:00:00', 'fffffffffffffff ffffffffffffffffffff', '2010-11-23', 1, 1, 0, 0, 'ffffffffffffffffffffffffffffff ffffff', 'ggggggggggggggggggg', 'fgggggggggggg gggggggggggggggggg fffffffffffffffffffffff', NULL, NULL),
(90, 'FGkldjslfkjdsklf fdskjdfklsd fkjfkjsdlf', 'http://test.by', '<p>\r\n	sddddddddddddddddddddddgsfgsfd dfghfdshhhhhhhhhhhhhhhhhhh</p>', '<p>\r\n	dsfhhhhhhhhhhhhhhhhhhhhhhhdfd fdssssssssssssfdgdfgdf&nbsp;&nbsp;&nbsp;&nbsp; fdgfdg</p>', '2010-11-23 00:00:00', 'hhhhhhhhhhhhhhhhhhhhhhhhh', '2010-11-23', 0, 1, 0, 0, 'ffffffffffffffffffffffffffffff fffffffffffffffffffffffffffffffff', 'fffffffffffffffffffffffffffffh     ddddddddddddddd', 'fffffffffffffffffffffffff fffffffffffffffffffffffff', 'Penguins.jpg', NULL);
...
INSERT INTO `site_portfolio` (`id`, `type`, `name`, `url`, `intro`, `content`, `pub`, `main`, `date_project`, `created_at`, `pub_date`, `seo_title`, `seo_keywords`, `seo_descriptions`, `small_img`, `big_img`) VALUES
